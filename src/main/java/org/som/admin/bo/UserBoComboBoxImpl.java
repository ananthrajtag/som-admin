...
import org.som.bean.GroupUserBean;
import org.som.bean.UserFormBean;
import org.som.bean.model.City;
import org.som.bean.model.Country;
import org.som.bean.model.States;
import org.som.dao.CityDao;
import org.som.dao.CountryDao;
import org.som.dao.GroupDao;
import org.som.dao.StateDao;
import org.som.dao.UserDao;
import org.som.security.resource.IErrorAdmin;
import org.som.security.resource.IPath;
...
public abstract class UserBoComboBoxImpl implements UserBo, IErrorAdmin, IPath
{
	...
	public List<LabelValueBean> getCountryList(Authentication auth, UserFormBean userFormBean)
	{
		...
		{
			_LBList.add(new LabelValueBean(country, country.getCountryName(), country.getCountry()));
		}
	...
	public List<LabelValueBean> getCityList(Authentication auth, UserFormBean userFormBean)
	{
		...
		{
			_LBList.add(new LabelValueBean(city, city.getCity() + EWrap.Brace.enclose(city.getState())));
		}
