...
import org.som.admin.bo.PasswordBo;
import org.som.bean.APIStatus;
import org.som.bean.PasswordFormBean;
import org.som.bean.UserFormBean;
import org.som.dao.UserDao;
import org.som.security.resource.IPathAdmin.ESecurity;
...
public class PasswordController implements IPasswordController
{
	...
	public ResponseEntity<?> changePassword(@RequestBody PasswordFormBean pfBean)
	{
		try
		{
			...
			{
				return new ResponseEntity<>(passwordBo.changePassword(pfBean), HttpStatus.OK);
			}
